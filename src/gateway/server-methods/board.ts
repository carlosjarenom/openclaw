...
import type { BoardStore, BoardWidgetStorePutParams } from "../../boards/board-store.js";
  ...
  return {
    ...
    "board.widget.put": async ({ params, respond, context }) => {
      ...
      try {
        ...
        let content: BoardWidgetStorePutParams["content"];
        ...
        const boardParams: BoardWidgetStorePutParams = {
