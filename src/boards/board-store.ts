...
export type BoardWidgetStorePutParams = Omit<BoardWidgetPutRequestParams, "content"> & {
...
export interface BoardStore {
  ...
  putWidget(params: BoardWidgetStorePutParams): BoardSnapshot;
  grant(
    sessionKey: string,
    name: string,
...
export function createBoardDeclaredSummary(
  declared: BoardWidgetStorePutParams["declared"],
): string[] | undefined {
  const lines = [
...
export function createBoardWidgetPutSnapshot(
  prior: BoardSnapshot,
  params: BoardWidgetStorePutParams,
