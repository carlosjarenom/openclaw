...
export const id: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Bilah samping",
      hint: "Pilih apa yang ditampilkan saat sesi berjalan.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Apa yang berubah pada sistem ini, yang terbaru lebih dulu.",
      ...
      sources: {
        ...
        settings: "pengaturan",
        cli: "CLI",
        pluginInstall: "instal plugin",
        manualEdit: "edit manual",
        unknown: "tidak diketahui",
      },
    },
    nudge: {
  ...
  labsPage: {
    ...
    sectionDescription:
      "Perubahan disimpan secara langsung dan berlaku untuk proses agen mendatang.",
  ...
  board: {
    ...
    emptyTitle: "Papan bersih, siap untuk bekerja",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Dok chat kiri",
      dockRight: "Dok chat kanan",
      dockBottom: "Dok chat bawah",
    ...
    composer: {
      ...
      noCameras: "Tidak ditemukan kamera tambahan",
