...
export const pl: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Pracownicy w chmurze wymagają środowiska uruchomieniowego OpenClaw; wybrano {runtime}.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma się pojawiać podczas działania sesji.",
  ...
  custodian: {
    ...
    placeholder: "Wiadomość do OpenClaw…",
  ...
  mcpServers: {
    ...
    targetInvalid: "Wprowadź adres URL http(s) lub wiersz poleceń.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowych, izolowanych przepływach JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Pozwól, aby Code Mode równolegle koordynował grupy subagentów.",
  ...
  appsPage: {
    ...
    sectionMobile: "Na Twoim telefonie",
    havePhone: "Masz już aplikację?",
    pairDevice: "Sparuj swoje urządzenie",
    sectionWatch: "Na Twoim nadgarstku",
    sectionDesktop: "Na Twoim komputerze",
    sectionBrowser: "W Twojej przeglądarce",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w polu wiadomości, mów, a następnie zwolnij, aby wstawić tekst bez wysyłania.",
