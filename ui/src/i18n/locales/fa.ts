...
export const fa: TranslationMap = {
  ...
  sessionsView: {
    ...
    attentionRequired: "جلسه به توجه نیاز دارد",
    model: "مدل",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "نوار کناری",
      hint: "انتخاب کنید در حین اجرای جلسه‌ها چه چیزی نمایش داده شود.",
      liveActivity: "نمایش فعالیت زنده عامل در نوار کناری",
      liveActivityHint: "آخرین فعالیت دستیار یا ابزار را زیر جلسه‌های در حال اجرا نمایش می‌دهد.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange: "قالب‌بندی یا نظرات بدون تغییرات مشهود در مسیر پیکربندی تغییر کرد.",
      sources: {
    ...
    nudge: {
      ...
      dismiss: "این به‌روزرسانی را رد کن",
    },
  },
  mcpServers: {
    add: "افزودن سرور",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS گفتگو کنید، صحبت کنید، اقدامات را تأیید کنید و محتوا را در OpenClaw به اشتراک بگذارید.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "گفتگوهای قابل مشاهده و پاسخ‌های سریع از روی مچ دست شما.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "همراه Android قابلیت OpenClaw را به ساعت شما گسترش می‌دهد.",
      },
      macos: {
        title: "macOS",
      ...
      linux: {
        title: "Linux",
        desc: "اپلیکیشن دسکتاپ بومی — نسخه‌های .deb و AppImage.",
      },
      chrome: {
        title: "افزونه Chrome",
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "نمایه هویت شما قابل بارگذاری نبود.",
      avatar: "آواتار",
      avatarDescription:
  ...
  board: {
    ...
    emptyTitle: "یک تخته خالی، آماده برای کار",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "هنگام کار عامل، تعویض شاخه در دسترس نیست.",
      branchSwitchRequiresAdmin: "تعویض شاخه نیازمند دسترسی مدیریتی اپراتور است.",
    ...
    board: {
      ...
      dockLeft: "اتصال گفتگو به چپ",
      dockRight: "اتصال گفتگو به راست",
      dockBottom: "اتصال گفتگو به پایین",
    ...
    questions: {
      ...
      skipping: "در حال رد کردن…",
      skipped: "ردشده",
      collapse: "جمع کردن سوال",
      expand: "گسترش سوال",
      eyebrow: "سوال",
      cardLabel: "سوال از دستیار",
      summaryLabel: "نتیجه سوال",
    ...
    composer: {
      ...
      holdToRecordSetting: "دکمه میکروفون را نگه دارید تا دیکته کنید",
    ...
    toolCards: {
      ...
      widgetExportRerender: "این ابزارک باید دوباره رندر شود تا به‌عنوان تصویر خروجی گرفته شود.",
