...
export const fr: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Afficher la dernière activité de l'assistant ou des outils sous les sessions en cours.",
    },
    connection: {
      title: "Connexion",
      gateway: "Gateway",
  ...
  sessionsPage: {
    hubTablistLabel: "Sections des fils de discussion",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Permettez aux agents de combiner des outils dans des flux de travail JavaScript compacts et isolés.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Aperçu des conversations et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmails: "Adresses e-mail liées",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone du compositeur, parlez, puis relâchez pour insérer du texte sans l'envoyer.",
