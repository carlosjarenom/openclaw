...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "삭제된 저장된 WhatsApp 세션이 없습니다. 이미 없거나, 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개의 스레드가 보관되었습니다",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "구성 다시 로드가 중지되었습니다 — 무슨 일인지 물어보세요",
      channelAuth: "{channel} 인증이 저하되었습니다 — 무슨 일인지 물어보세요",
      channelDisconnected: "{channel} 연결이 끊겼습니다 — 무슨 일인지 물어보세요",
  ...
  mcpServers: {
    ...
    nameInvalid: "서버 이름에는 문자, 숫자, 마침표, 대시 또는 밑줄을 사용합니다.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 컴팩트하고 샌드박스화된 JavaScript 워크플로에서 도구를 결합하도록 합니다.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저용 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인까지.",
    sectionMobile: "휴대폰에서",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "표시 이름",
      displayNameDescription: "이 gateway를 사용하는 다른 사람들에게 표시됩니다.",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt를 누른 채 화살표 키를 누르면 이동합니다.",
      moveHandle: "{title} 이동",
