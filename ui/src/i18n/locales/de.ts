...
export const de: TranslationMap = {
  ...
  sessionsView: {
    ...
    waitingForApproval: "Warte auf Genehmigung",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Aktivieren Sie sie unter Systemeinstellungen > Benachrichtigungen.",
    },
    appearance: {
      theme: "Design",
  ...
  mcpServers: {
    ...
    connectRequired: "Mit dem Gateway verbinden, um MCP-Server zu ändern.",
  ...
  mcpPage: {
    connectorsLink: "Entdecke Ein-Klick-Konnektoren auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Releases ändern, defekt sein oder verschwinden können.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Handy, Uhr, Desktop und Browser – plus Plugins, um die Fähigkeiten deines Agenten zu erweitern.",
    sectionMobile: "Auf deinem Handy",
    havePhone: "Hast du die App bereits?",
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "Die Windows-Begleit-App verbindet deinen PC als OpenClaw-Node.",
      },
      linux: {
        title: "Linux",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Board-Ansicht Nahtstelle · {tabs} Tabs · {widgets} Widgets",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden angewendet, wenn Sie Ihre nächste Talk-Sitzung starten.",
      ...
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofontaste im Editor gedrückt, sprechen Sie und lassen Sie los, um Text einzufügen, ohne ihn zu senden.",
      ...
      dictationDisconnected:
        "Das Diktat wurde beendet, weil das Gateway die Verbindung getrennt hat.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Das Diktat wurde beendet, bevor das letzte partielle Transkript abgeschlossen werden konnte.",
