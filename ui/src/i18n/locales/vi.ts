...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào được lưu bị xóa. Có thể phiên đã không còn, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Worker trên đám mây yêu cầu runtime OpenClaw; {runtime} đang được chọn.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Thông báo đang bị tắt cho OpenClaw trong macOS. Cho phép chúng trong System Settings > Notifications.",
    },
    appearance: {
      theme: "Giao diện",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Chỉnh sửa thủ công này không vượt qua kiểm tra cấu hình.",
      opaqueChange:
  ...
  labsPage: {
    intro:
      "Labs chứa các khả năng thử nghiệm có thể thay đổi, hỏng hoặc biến mất giữa các phiên bản.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript nhỏ gọn, sandbox.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng các plugin để mở rộng những gì tác nhân của bạn có thể làm.",
    sectionMobile: "Trên điện thoại của bạn",
    havePhone: "Đã có ứng dụng rồi?",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh cuộc trò chuyện và trả lời nhanh từ cổ tay của bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Chọn hình ảnh có kích thước 10 MB trở xuống.",
  ...
  board: {
    ...
    emptyHint: "Tác nhân của bạn có thể ghim widget tại đây — hãy thử yêu cầu một thẻ trạng thái.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Chuyển nhánh yêu cầu quyền quản trị người vận hành.",
    ...
    board: {
      ...
      mockPlaceholder: "Đường ghép chế độ bảng · {tabs} thẻ · {widgets} tiện ích",
    ...
    composer: {
      ...
      dictationDisconnected: "Đã dừng đọc chính tả vì Gateway đã ngắt kết nối.",
      dictationFailed: "Đọc chính tả thất bại.",
      dictationFinalizing: "Đang hoàn tất đọc chính tả…",
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi có thể hoàn tất bản chép lời một phần cuối cùng.",
      ...
      dictationReleaseToInsert: "Thả ra để chèn văn bản đọc chính tả",
