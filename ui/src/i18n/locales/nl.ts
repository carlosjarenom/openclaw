...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Afgemeld.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Deze is mogelijk al afwezig, of de authenticatiemap moet handmatig worden opgeschoond.",
    },
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Meldingen worden natief weergegeven door de OpenClaw-app op deze Mac.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "Configuratie herladen gestopt — vraag me wat er gebeurd is",
      channelAuth: "{channel}-authenticatie verslechterd — vraag me wat er gebeurd is",
      channelDisconnected: "{channel} is zojuist verbroken — vraag me wat er gebeurd is",
  ...
  mcpPage: {
    connectorsLink: "Ontdek connectors met één klik op de pagina Plug-ins.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele functies die tussen releases kunnen veranderen, breken of verdwijnen.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Menubalk-companion voor je Gateway — meldingen, goedkeuringen, snel chatten.",
      },
      windows: {
        title: "Windows",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Chat links dokken",
      dockRight: "Chat rechts dokken",
      dockBottom: "Chat onderaan dokken",
