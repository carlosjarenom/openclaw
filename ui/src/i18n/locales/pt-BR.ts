...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão armazenada do WhatsApp foi apagada. Ela pode já estar ausente, ou seu diretório de autenticação pode exigir limpeza manual.",
    },
  ...
  subtitles: {
    ...
    security: "Autenticação do Gateway, política de exec, perfil de ferramenta e aprovações.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "A formatação ou os comentários mudaram sem alterações visíveis no caminho da configuração.",
      sources: {
    ...
    nudge: {
      configReload: "Recarregamento da configuração interrompido — pergunte-me o que aconteceu",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats rápidos de relance e respostas ágeis direto do seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Complemento na barra de menu para o seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Aplicativo desktop nativo — builds .deb e AppImage.",
      },
      chrome: {
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantenha pressionado o botão do microfone do compositor, fale e solte para inserir texto sem enviar.",
