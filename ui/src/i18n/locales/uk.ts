...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Збережену сесію WhatsApp не очищено. Можливо, вона вже відсутня, або її каталог автентифікації потребує ручного очищення.",
    },
  ...
  sessionsView: {
    ...
    runFailedReason: "Помилка запуску: {reason}",
  ...
  execApproval: {
    ...
    reviewRequest: "Перегляньте підтвердження від {agent}: {command}",
  ...
  subtitles: {
    ...
    security: "Автентифікація Gateway, політика exec, профіль інструментів і підтвердження.",
  ...
  custodian: {
    ...
    connectionChanged:
      "Зʼєднання з Gateway змінилося. Повторіть спробу, щоб продовжити це налаштування.",
    ...
    nudge: {
      ...
      channelAuth: "Автентифікація {channel} погіршилась — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    nameTaken: "MCP-сервер із назвою «{name}» уже існує.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Дозволяє агентам комбінувати інструменти в компактних, ізольованих робочих процесах JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Дозволяє Code Mode оркеструвати групи субагентів паралельно.",
  ...
  appsPage: {
    heroTitle: "Використовуйте OpenClaw будь-де",
    heroTagline:
    ...
    badgeBundledIos: "У складі застосунку для iOS",
    badgeBundledAndroid: "У складі застосунку для Android",
  ...
  board: {
    ...
    announcement: {
      ...
      granted: "Доступ віджета дозволено.",
      rejected: "Доступ віджета відхилено.",
    },
    widget: {
      cellLabel:
        "Віджет інформаційної панелі: {title}. Використовуйте клавіші зі стрілками для навігації. Утримуйте Alt і натисніть стрілку, щоб перемістити його.",
  ...
  chat: {
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено до завершення останнього часткового транскрибування.",
      dictationProviderUnavailable: "Для диктування не налаштовано провайдера транскрибування.",
