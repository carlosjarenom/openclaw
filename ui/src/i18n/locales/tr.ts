...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten yok olabilir ya da kimlik doğrulama dizini elle temizlenmeyi gerektirebilir.",
    },
  ...
  agentChip: {
    ...
    agents: "Ajanlar",
    openChat: "{name} ile sohbet edin",
    offlineOpenSettings: "Çevrimdışı — Ayarları açın",
  ...
  subtitles: {
    ...
    advanced: "Kalan tüm yapılandırma bölümleri, ayrıca ham dosya düzenleyici.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} bozuk durumda — ne olduğunu bana sorun",
  ...
  mcpPage: {
    connectorsLink: "Plugins sayfasında tek tıkla bağlanan konnektörleri keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Code Mode'un alt aracı gruplarını paralel olarak yönetmesine izin verin.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'ta OpenClaw ile sohbet edin, konuşun, eylemleri onaylayın ve paylaşın.",
      },
      android: {
        title: "Android",
      ...
      windows: {
        title: "Windows",
        desc: "Windows eşlik uygulaması PC'nizi bir OpenClaw düğümü olarak bağlar.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    widget: {
      ...
      rejectedDetail: "Bu widget, kaldırılana veya değiştirilene kadar etkin olmayacaktır.",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Pano görünümü kenarı · {tabs} sekme · {widgets} widget",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Oluşturucu mikrofon düğmesini basılı tutun, konuşun ve ardından metni göndermeden eklemek için bırakın.",
