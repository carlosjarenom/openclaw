...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    labs: "Funciones experimentales de agentes y herramientas.",
  ...
  mcpServers: {
    ...
    adminRequired: "Los cambios en servidores MCP requieren acceso operator.admin.",
    enable: "Activar",
    disable: "Desactivar",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Complemento de la barra de menús para tu Gateway: notificaciones, aprobaciones y chat rápido.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "No se pudo cargar el perfil de tu identidad.",
      avatar: "Avatar",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente lo sigue viendo.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Es necesario volver a renderizar este widget para exportarlo como imagen.",
